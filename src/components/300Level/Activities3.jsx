...
export default async function Activities3() {
  const allStudents = await LevelThree.countDocuments();
  return (
    <section id="all-cards " class="all-cards ">
      <div id="twoCards" class="container">
        <div class="section-title">
          <h2 data-aos="fade-up" data-aos-delay="100">
            List of 300 Level Activities
          </h2>
          <hr />
          <p data-aos="fade-up" data-aos-delay="200">
            Here are the list of all possible activities in 300 Level.
            <br />
        ...
        <div class="row g-4">
          <div className="col-6 col-lg-3 text-lg-start text-center ">
            <div className="card p-3 icon-box" data-aos="fade-up">
              ...
              <h4 class="title">
                <a href="/levelTwo/allTable">Total Students</a>
              </h4>
